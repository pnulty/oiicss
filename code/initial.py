# -*- coding: utf-8 -*-
"""
Created on Sun Sep 14 19:57:39 2014

plan: 

1. do twitter retrieval
2. clean tweets heuristically
3. parse tweets syntactically
4. keyword search
...
"""
Stream listener code based on examples by Scott McHale
...
access_token_secret="IeC6iYlgUK9csWiP524Jb4UNM8RtQmHyetLi9NZrkJA"
auth = OAuthHandler(consumer_key, consumer_secret)
auth.set_access_token(access_token, access_token_secret)
listener = FileDumperListener(outputDir)
terms = ["indyref", "salmond", "cameron", "scotland", "scottish", "referendum", "vote", "voted", "voting"]
